    ...
    <DropdownMenu>
      ...
      >
        ...
        <div className="p-1.5 space-y-0.5">
          ...
          <DropdownMenuItem asChild className="flex cursor-pointer items-center gap-2.5 rounded-md px-2 py-2 text-sm text-ps-text hover:bg-ps-surface focus:bg-ps-surface focus:text-ps-text">
            <a href="mailto:support@superalien.app">
